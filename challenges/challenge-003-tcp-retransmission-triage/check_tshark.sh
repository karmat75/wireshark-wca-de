...
PCAP="${1:-pcaps/generated/challenge-003-tcp-retransmission-triage.pcapng}"

if [ ! -f "$PCAP" ]; then
  echo "ERROR: PCAP not found: $PCAP" >&2
  echo "Usage: bash challenges/challenge-003-tcp-retransmission-triage/check_tshark.sh <pcap-file>" >&2
  exit 2
fi
